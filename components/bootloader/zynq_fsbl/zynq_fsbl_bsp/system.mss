...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = algorithm_parameters
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = algorithm_parameters_0
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = axi_vdma_result
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.2
 PARAMETER HW_INSTANCE = background_buffer_vdma_previous_frame
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.2
 PARAMETER HW_INSTANCE = frame_buffer_vdma_previous_frame
END
